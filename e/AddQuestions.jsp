...
System.out.println("session value is:"+cname);%>
<html>
    <head>
                ...
                Statement st1 = con.createStatement();
                            ...
                            <tr>
                                ...
                                <td bordercolor="#996633" bgcolor="#EBD8D8"><label>
                                        <select name="jobid" id="jobid">
                                            <%ResultSet rs1 = st1.executeQuery("select * from JobDetails where company='"+cname+"'");
                                          String s = null;
                                          // String s2=null;
                                          while (rs1.next()) {
                            ...
                            <tr>
                                ...
                                <td width="255" bordercolor="#996633" bgcolor="#EBD8D8">
                                    <label>
                                        <select name="examid">
                                            <%ResultSet rs = st.executeQuery("select * from Exam where company='"+cname+"'");
                                          String s1 = null;
                                          // String s2=null;
                                          while (rs.next()) {
