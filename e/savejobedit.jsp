...
<html>
    ...
    <body>
        ...
        Connection con=DriverManager.getConnection("jdbc:odbc:exam"," "," ");
            ...
            st.executeUpdate("Update JobDetails set Post='" + request.getParameter("post") + "',Criteria='" + request.getParameter("criteria") + "',NoOfVacancies='" + request.getParameter("vacancies") + "',Salary='" + request.getParameter("salary") + "' where JobId='" + jid + "'");
            %>
