    ...
    <table width="100%" height="390" border="1">
                        ...
                        <table width =85% border=0 cellpadding=3 cellspacing=0 bordercolor="#FFFFFF" >
                            ...
                            <tr bgcolor =#FEF7E9>
                                ...
                                <td bgcolor="#F2DFE2"><div align="left">
                                        <input NAME="compost" TYPE="text" id="compost" size=30  maxlength=50>&nbsp&nbsp(e.g.Manager,Software Developer,etc)
                                </div></td>
                            </tr>
                            <tr bgcolor =#FEF7E9>
                                <td bgcolor="#F2DFE2"><div align="left"><font SIZE="2" COLOR="black" face =arial>Criteria</font></div></td>
                                <td bgcolor="#F2DFE2"><div align="left">
                                        <select name="comcriteria"><option value="Fresher">Fresher</option>
		<option value="Experienced">Experienced</option></select>
                            ...
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF"><div align="left">
                                        <input TYPE="text" NAME="comcontact" id="comcontact" size=30 maxlength=30 >
